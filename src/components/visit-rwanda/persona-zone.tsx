...
const CONTENT: Record<string, PersonaContent> = {
  tourist: {
    ...
    quickLinks: [
      { label: "Explore destinations", href: "#discover" },
      { label: "Signature experiences", href: "#experiences" },
      { label: "Visa & travel", href: "#travel" },
    ],
  ...
  investor: {
    ...
    quickLinks: [
      ...
      { label: "Economic data", href: "#invest" },
  ...
  student: {
    ...
    quickLinks: [
      { label: "Universities & research", href: "#live" },
      { label: "Country facts", href: "#travel" },
      { label: "Latest news", href: "#connect" },
    ],
  ...
  artist: {
    ...
    quickLinks: [
      ...
      { label: "Creative economy", href: "#live" },
    ],
  ...
  athlete: {
    ...
    quickLinks: [
      { label: "Football & cycling", href: "#live" },
      { label: "Events calendar", href: "#connect" },
      { label: "Sports news", href: "#connect" },
    ],
  ...
  expat: {
    ...
    quickLinks: [
      { label: "Safety & essentials", href: "#travel" },
      { label: "Culture & language", href: "#live" },
      { label: "Live news", href: "#connect" },
    ],
